...
public class Massiv {
    public static void main(String[] args) {
        ...
        for (int j : arr) {
            if (j > 0) {
                pozCount += 1;            //Нахождение количества положительных элементов
                pozSum += j;           //Нахождение суммы положительных элементов
            } else if (j < 0) {
                negCount += 1;            //Нахождение количества отрицательных элементов
                negSum += j;           //Нахождение суммы отрицательных элементов
            }
        }
